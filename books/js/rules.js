...
DangerSqrCycle.addEventListener("click", () => {
  ...
  else if (DangerSqrCycle.classList.contains("DangerSqr-3")) {
    DangerSqrCycle.classList.remove("DangerSqr-3");
    DangerSqrCycle.classList.add("DangerSqr-4");
  }
  else if (DangerSqrCycle.classList.contains("DangerSqr-4")) {
    DangerSqrCycle.classList.remove("DangerSqr-4");
    DangerSqrCycle.classList.add("DangerSqr-5");
  }
  else if (DangerSqrCycle.classList.contains("DangerSqr-5")) {
    DangerSqrCycle.classList.remove("DangerSqr-5");
    DangerSqrCycle.classList.add("DangerSqr-6");
  }
  else if (DangerSqrCycle.classList.contains("DangerSqr-6")) {
    DangerSqrCycle.classList.remove("DangerSqr-6");
    DangerSqrCycle.classList.add("DangerSqr-7");
  }
  else {
    DangerSqrCycle.classList.remove("DangerSqr-7");
